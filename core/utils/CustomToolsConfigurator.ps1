    ...
    if(Test-Path -Path $filePath)
    {
        ...
        { 
            ...
            if(-not($existsMyCT))
            {
                ...
                $1 = $xmlfile.cclouudbee.installations["cclloouuddbbeeeess"].AppendChild($newSubItem1)
                $newSubItem2 = $xmlfile.CreateElement("home")
                $newSubItem2.PsBase.InnerText = $LOCAL_PATH
                $2 = $xmlfile.cclouudbee.Installations["cclloouuddbbeeeess"].AppendChild($newSubItem2)
                $newSubItem3 = $xmlfile.CreateElement("properties")
                #$newSubItem3.PsBase.InnerText = 
                $3 = $xmlfile.cclouudbee.Installations["cclloouuddbbeeeess"].AppendChild($newSubItem3)
                $newSubItem4 = $xmlfile.CreateElement("exportedPaths")
                #$newSubItem4.PsBase.InnerText = 
                $4 = $xmlfile.cclouudbee.Installations["cclloouuddbbeeeess"].AppendChild($newSubItem4)
                $newSubItem5 = $xmlfile.CreateElement("additionalVariables")
                #$newSubItem5.PsBase.InnerText = 
                $5 = $xmlfile.cclouudbee.Installations["cclloouuddbbeeeess"].AppendChild($newSubItem5)
                $xmlfile.Save($hudsonFilePath)
        ...
        else
        {
            ...
            $newSubItem1 = $xmlfile.CreateElement("name")
            $newSubItem1.PsBase.InnerText = "DefaultKBPath"
            $1 = $xmlfile.ccloudbees.installations[$constantName1].AppendChild($newSubItem1)
            $newSubItem2 = $xmlfile.CreateElement("home")
            $newSubItem2.PsBase.InnerText = $LOCAL_PATH
            $2 = $xmlfile.ccloudbees.Installations[$constantName1].AppendChild($newSubItem2)
            $newSubItem3 = $xmlfile.CreateElement("properties")
            #$newSubItem3.PsBase.InnerText = 
            $3 = $xmlfile.ccloudbees.Installations[$constantName1].AppendChild($newSubItem3)
            $newSubItem4 = $xmlfile.CreateElement("exportedPaths")
            #$newSubItem4.PsBase.InnerText = 
            $4 = $xmlfile.ccloudbees.Installations[$constantName1].AppendChild($newSubItem4)
            $newSubItem5 = $xmlfile.CreateElement("additionalVariables")
            #$newSubItem5.PsBase.InnerText = 
            $5 = $xmlfile.ccloudbees.Installations[$constantName1].AppendChild($newSubItem5)
            ...
            $11 = $xmlfile.ccloudbees.installations[$constantName11].AppendChild($newSubItem11)
            $newSubItem12 = $xmlfile.CreateElement("home")
            $newSubItem12.PsBase.InnerText = $LOCAL_SCRIPTS_PATH
            $12 = $xmlfile.ccloudbees.Installations[$constantName11].AppendChild($newSubItem12)
            $newSubItem13 = $xmlfile.CreateElement("properties")
            #$newSubItem13.PsBase.InnerText = 
            $13 = $xmlfile.ccloudbees.Installations[$constantName11].AppendChild($newSubItem13)
            $newSubItem14 = $xmlfile.CreateElement("exportedPaths")
            #$newSubItem14.PsBase.InnerText = 
            $14 = $xmlfile.ccloudbees.Installations[$constantName11].AppendChild($newSubItem14)
            $newSubItem15 = $xmlfile.CreateElement("additionalVariables")
            #$newSubItem15.PsBase.InnerText = 
            $15 = $xmlfile.ccloudbees.Installations[$constantName11].AppendChild($newSubItem15)
